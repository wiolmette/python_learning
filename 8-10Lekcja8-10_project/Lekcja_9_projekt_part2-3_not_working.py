...
def losowanie(Uczestnicy):
    ...
    print(Uczestnicy2, len(Uczestnicy2), losowy_uczestnik1)
    ...
    print(Uczestnicy2, len(Uczestnicy2), losowy_uczestnik2)
    ...
    print(Uczestnicy2, len(Uczestnicy2), losowy_uczestnik3)
    ...
    print(Uczestnicy2, len(Uczestnicy2), losowy_uczestnik4)
    ...
    print(Uczestnicy2, len(Uczestnicy2), losowy_uczestnik5)
    ...
    print(Uczestnicy2, len(Uczestnicy2), losowy_uczestnik6)
    ...
    print(Uczestnicy2, len(Uczestnicy2), losowy_uczestnik7)
    ...
    print(Uczestnicy2, len(Uczestnicy2), losowy_uczestnik8)
    ...
    print(Uczestnicy2, len(Uczestnicy2), losowy_uczestnik9)
